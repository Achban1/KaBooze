...
public class Molotov : MonoBehaviour
{
    ...
    [Header("Audio")]
    public AudioSourcePoolBottles audioSourcePoolFlask;
    public AudioSourcePoolExplosion audioSourcePoolExp;
    ...
    void Start()
    {
        ...
        audioSourcePoolFlask = GameObject.FindGameObjectWithTag("MainCamera").GetComponent<AudioSourcePoolBottles>();
        audioSourcePoolExp = GameObject.FindGameObjectWithTag("MainCamera").GetComponent<AudioSourcePoolExplosion>();
    ...
    private void OnCollisionEnter2D(Collision2D col)
    {
        ...
        {
            audioSourcePoolFlask.BottleSoundFX();
            Destroy(gameObject); 
        }
    }
